...
namespace QIndependentStudios.Obex.Tests.Converter.Response
{
    ...
    public class ObexConnectResponseConverterTests
    {
        ...
        private static readonly ObexConnectResponse _testConnectResponse = ObexConnectResponse.Create(ObexResponseCode.Ok,
            31,
            0x10,
            0x00,
            5120,
        ...
        {
            var actual = _converter.FromBytes(_testConnectResponseData);
        ...
        {
            var actual = _converter.ToBytes(_testConnectResponse);
