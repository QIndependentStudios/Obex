...
namespace QIndependentStudios.Obex.Tests
{
    ...
    {
        private const string _testFolder = "telecom";
        ...
        {
            var header = TextObexHeader.Create(ObexHeaderId.Name, _testFolder);
        ...
        public void Create_SetPathFlag_HeaderEnumerable_RequestCreatesCorrectly()
        {
            ...
            {
                TextObexHeader.Create(ObexHeaderId.Name, _testFolder)
            };
